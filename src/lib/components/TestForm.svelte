<form action="/form/tsnc-lbyb-klyy-zk52" method="post">
  ...
  <select id="dropdowns" name="dropdowns" multiple>
    <option value="cloudflare" selected> Cloudflare Option </option>
    <option value="typescript" selected> TypeScript Option </option>
    <option value="hono" selected> Hono Option </option>
